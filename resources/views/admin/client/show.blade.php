...
<div class="content-wrapper">
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Panel administrador</a></li> <li class="breadcrumb-item"><a href="{{route('client.index')}}">Clientes</a></li>
        ...
        <div class="col-12">
            <div class="card">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="border-bottom py-4">
                                <div class="list-group">
                                    ...
                                    <!--<button type="button" class="list-group-item list-group-item-action">Registrar Cliente</button> -->
                ...
                <div class="card-footer text-muted">
                    <a href="{{route('client.index')}}" class="btn btn-primary float-right">Regresar</a>
                </div>
            </div>
        </div>
    </div>
