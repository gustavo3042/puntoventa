...
<div class="content-wrapper">
    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Panel administrador</a></li> <li class="breadcrumb-item"><a href="{{route('provider.index')}}">Proveedores</a></li>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer text-muted">
                    <a href="{{route('provider.index')}}" class="btn btn-primary float-right">Regresar</a>
                </div>
            </div>
        </div>
    </div>
