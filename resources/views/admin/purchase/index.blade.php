                            ...
                            @foreach ($purchases as $purcha)
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  @if ($purcha->status == 'VALID')
                                    <td>

                                    <a class="jsgrid-button btn btn-success" href="{{route('change.status.purchases', $purcha)}}" title="Editar">
                                  ...
                                  @else
                                    ...
                                    <a class="jsgrid-button btn btn-danger" href="{{route('change.status.purchases', $purcha)}}" title="Editar">
