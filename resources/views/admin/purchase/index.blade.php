                                ...
                                <td>
                                  ...
                                  <td> {{$purcha->total}}</td>
                                    ...
                                    <td width='50px'>
                                      ...
                                      {!! Form::open(['route'=>['purchase.destroy',$purcha],'method'=>'DELETE']) !!}


                                      <a class="jsgrid-button jsgrid-edit-button" href="{{route('purchase.edit', $purcha)}}" title="Editar">
